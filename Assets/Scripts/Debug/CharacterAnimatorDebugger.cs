...
public class CharacterAnimatorDebugger : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        if (ShowCharacterMotion) {
            ...
            GUI.Box(new Rect(10, 60, 350, 20), "Current State: " + _character.StateMachine [_character.CurrentState.fullPathHash].Method.Name.ToString() + ", Current Zone: " + _character.CurrentZone);
        ...
        if (ShowZLevels) {
            ...
            GUI.Box(new Rect(10, 110, 350, 20), "Jump: " + _character.CharInput.Jump + ", JF: " + _character.InputJumpForward + ", JB: " + _character.InputJumpBackward);
            GUI.Box(new Rect(10, 135, 350, 20), "Grab Wall: " + _character.CanGrabWall);
        }
